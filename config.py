...
كل هذه القيم قابلة للتعديل، لكنها مصممة افتراضيا لمخاطرة منخفضة.
"""
...
# أسهم كبيرة ووسائل من قطاعات متنوعة (تقنية, طاقة, صحة, استهلاك, صناعة, تمويل)
...
WATCHLIST = [
    ...
    # صناعة
    "CAT", "BA",
    # ذكاء اصطناعي (تعزيز إضافي)
    "AMD", "PLTR", "AVGO",
    # نحاس (تعدين ومعدن مباشر)
    "CPER",
    # صناديق مؤشرات واسعة (تنويع إضافي داخل الصفقة الواحدة)
    "SPY", "QQQ",
    # عملات مشفرة (تداول متاح 24/7 حتى في العطلات)
...
TAKE_PROFIT_PCT = 0.04         # جني أرباح تلقائي عند +4% (عائد:مخاطرة = 1:2)
