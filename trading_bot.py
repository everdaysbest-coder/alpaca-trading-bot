...
🔍 سطر تشخيصي مؤقت مضاف: يطبع عدد أيام الأسعار الفعلي المستلم من Alpaca،
عشان نتأكد هل هو كافٍ (20+) لحساب المتوسطات المتحركة، أو ناقص وهذا سبب
"فني: neutral" الثابت اللي شفناه بكل الأسهم.
...
def main():
    ...
    for symbol in WATCHLIST:
        ...
        print(f"   📦 عدد أيام الأسعار المستلمة: {len(prices)} (المطلوب على الأقل: 20)")
        if not prices:
